...
namespace Z_Type
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            fallingWords(ran, textToArrey, wordsCount, start, list);
        }

        private static void fallingWords(Random ran, string[] textToArrey, int wordsCount, DateTime start, List<Queue<char>> list)
        {
