namespace VehicleParkSystem
{
    ...
    public class VehiclePark : IVehiclePark
    {
        ...
        public string FindVehiclesByOwner(string owner)
        {
            ...
            {
                var foundVehicles =
                    this.data.VehiclesByOwner[owner].OrderBy(v => this.data.VehiclesByStartTime[v])
        ...
        private string PrintTicket(IVehicle vehicle, int hours, decimal amountPaid)
        {
            ...
            decimal overtimeRate = hours > vehicle.ReservedHours
            ...
            ticket.AppendLine(ticketSeparator)
                ...
                .AppendLine()
                .AppendFormat("at place {0}", this.data.VehiclesInParkPlaces[vehicle])
                .AppendLine()
                ...
                .AppendFormat("Total: ${0:F2}", rate + overtimeRate)
                .AppendLine()
                .AppendFormat("Paid: ${0:F2}", amountPaid)
                .AppendLine()
                .AppendFormat("Change: ${0:F2}", amountPaid - (rate + overtimeRate))
                .AppendLine()
            ...
            var vehiclesAsStrings =
                vehicles.Select(
                    ...
                    string.Format(
                        ...
                        vehicle.ToString(),
                        Environment.NewLine,
                        this.data.VehiclesInParkPlaces[vehicle]));
